...
export async function getTags(binderId: string): Promise<Tag[]> {
  const res = await apiFetch(`${API_URL}/api/binders/${binderId}/tags`);
...
export async function getTag(
  ...
  const res = await apiFetch(`${API_URL}/api/binders/${binderId}/tags/${tagId}`);
...
export async function createTag(
  ...
  const res = await apiFetch(`${API_URL}/api/binders/${binderId}/tags/create`, {
    method: 'POST',
